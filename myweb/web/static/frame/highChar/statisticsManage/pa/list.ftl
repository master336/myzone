...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.main.pa")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<div class="input tabContent">
			<table id="listTable" class="list">
				<tr>
					...
					<th>
						<span>${message("pa.varietiesName")}</span>
					</th>
					<th>
						<span>${message("pa.totalOutput")}</span>
					</th>
					<th>
						<span>${message("pa.growAcreage")}</span>
					</th>
				</tr>
