...
public class MD5
{
    ...
    public static void main(String args[])
    {
        ...
        if (Array.getLength(args) == 0)
        {
            ...
            String ret=md5.getMD5ofStr("1239875013071158889"+c+"1401211593tmobiewcom");
            System.out.println("MD5(\"\"):" + ret);

            if (ret.equalsIgnoreCase("39d7eb4a02d2688f49d5bf9b04cc8bc1"))
            {
